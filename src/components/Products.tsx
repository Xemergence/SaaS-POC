...
function ProductCard({
  ...
  return (
    <div className="bg-[#1e1e2d] rounded-lg border border-[#2a2a3a] hover:border-[#7b68ee] transition-all group overflow-hidden">
      {/* Product Image */}
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          <div className="flex flex-wrap gap-1">
            {product.features.slice(0, 2).map((feature, index) => (
              <span
                key={index}
                className="text-xs bg-[#2a2a3a] text-gray-300 px-2 py-1 rounded"
              >
                {feature}
              </span>
            ))}
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="flex-1 bg-[#7b68ee] hover:bg-[#6a5acd] text-white disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
          ...
          <Button
            ...
            variant="outline"
            className="border-[#2a2a3a] bg-[#2a2a3a] text-white hover:bg-[#353545] disabled:opacity-50"
          >
            {isInCart ? (
